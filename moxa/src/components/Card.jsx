 ...
 useEffect(() => {
  ...
  return (
    <motion.div
      ...
      animate={controls}
      variants={variants}
      className="w-[24vw] bg-sky-200 rounded-md drop-shadow-[0_2.2px_2.2px_rgba(0,0,0,0.8)] "
    >
      <h2 className='font-montserrat text-[1.6vw] h-[10vh] font-bold text-start px-[2vw] py-[4vh] text-gray-900 drop-shadow-md shadow-black-600/50 shadow-3xl'>{title}</h2>
