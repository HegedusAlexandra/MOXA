  ...
  return (   
    <motion.main exit={{ opacity: 0 }} className="w-[100%] h-[100vh] bg-cyan-950 flex flex-col overflow-x-hidden justify-center items-start">    
      ...
      <img src={devices_screen_content} className={
        ...
        (screenWidth > 800 && screenWidth < 1500) ? 'absolute h-[100vh] object-cover bottom-8' : 
        "absolute h-[100vh] object-cover rotate-90 left-0"} 
        alt="loading..."/>     
      <div className={
          screenWidth < 800 ? "absolute z-10 w-[100%] h-[30%] backdrop-blur-md bg-white/30 top-0 flex flex-col justify-end" :
          (screenWidth < 1500 && screenWidth > 800) ? `absolute z-2 w-[60%] h-[20%] right-0 top-[20%] rounded-lg flex flex-col justify-end backdrop-blur-md bg-white/30` : `absolute z-2 w-[40%] h-[20%] right-0 top-[20%] rounded-lg flex flex-col justify-end backdrop-blur-md bg-white/30`}>
      ...
      <div className='absolute z-1 w-[100%] h-[100%]'>        
        ...
        <div className={screenWidth > 1500 ? 'absolute z-2 w-[20%] h-[100%] rounded-lg flex flex-col justify-center px-10' : screenWidth < 500 ? "hidden" : `absolute z-3 left-[${screenWidth< 1000 ? 5 : 40}] w-[${screenWidth < 1000 ? 94 : 40}%] rounded-lg flex flex-col justify-center p-[${screenWidth < 1000 ? 6 : 10}] m-[6vw] bottom-20 backdrop-blur-lg bg-cyan-100/50`} >
          <p className={`text-[${screenWidth > 1500 ? 16 : 12}px] font-montserrat p-[1%]`}>
